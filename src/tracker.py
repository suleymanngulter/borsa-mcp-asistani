...
def get_stock_price(symbol: str, retry_count: int = 3) -> Dict[str, float]:
    """
...
def get_fund_price(symbol: str, retry_count: int = 3) -> Dict[str, float]:
    """
    ...
    for attempt in range(retry_count):
        try:
            ...
            # Son 7 günün verisini çek (bugün ve önceki günler)
